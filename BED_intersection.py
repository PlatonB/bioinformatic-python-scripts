...
Авторы: Платон Быкадоров, Илья Воронцов. 2016-2017.
...
##Прочтение "одиночной таблицы и её оптимизация для производимых далее пересечений.
...
for sourcefile1 in sourcefiles1:
        ...
        #Если конечное множество пересечений - пустое, то не создаём конечный файл, а начинаем пересекать "одиночный" трек со следующим BEDом.
        if len(targetset) == 0:
                continue
