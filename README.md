...
- Со знанием программирования
	- если желаете помогать развитию проекта
...
- (Сведения для программистов)
	...
	- Не импортируют друг с друга
	- Используются функции исключительно стандартной библиотеки
	- Подробно прокомментированы все блоки кода
	- Человеко-понятные имена переменных
...
# Качество.
1. Тестирование на элементарных выборках
	- позволяет легко визуально оценить правильность результатов
2. Тестирование на реальных данных
	- Опубликованные на данный момент скрипты прошли проверку в рамках моих научных и научно-коммерческих работ
