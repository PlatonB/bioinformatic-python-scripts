...
## Язык - Python 3.
Для написания кода основатель проекта выбрал язык Python 3, т.к. он довольно простой и включает в себя большое количество готовых функций для работы с текстовой информацией.
...
Частичное переписывание кода опубликованного скрипта: `от 500 до 1000 руб.`.
Полное или почти полное переписывание кода опубликованного скрипта, либо создание скрипта с нуля: `от 1000 до 5000 руб.`.
Крупные работы, как, например, создание целого скриптового конвейера для вашей научной работы: `цена договорная`.
