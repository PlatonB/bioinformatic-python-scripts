...
<h5>Вариант <code>I.<\code> Автоматическое сохранение всего репозитория (рекомендую)</h5>
<code>1.<\code> <code>Clone or download<\code>.
<code>2.<\code> <code>Download ZIP<\code>.
<code>3.<\code> Распакуйте архив со всеми скриптами.

<h5>Вариант <code>II.<\code> Вручную по одному скрипту</h5>
<code>1.<\code> Создайте файл с расширением .py.
<code>2.<\code> Откройте его с помощью IDLE.
<code>3.<\code> <code>Ctrl+V<\code> - вставьте скрипт из этого репозитория.
<code>4.<\code> <code>Ctrl+S<\code> - сохраните.

<h5>Вариант <code>III.<\code> Вручную по одному скрипту</h5>
<code>1.<\code> Откройте IDLE.
<code>2.<\code> <code>Ctrl+N<\code> - создайте новый файл.
<code>3.<\code> <code>Ctrl+V<\code> - вставьте скрипт из этого репозитория.
<code>4.<\code> <code>Ctrl+S<\code> - сохраните.
...
<code>1.<\code> <code>F5<\code> - запустите скрипт.
<code>2.<\code> Следуйте указаниям в появившейся интерактивной оболочке Python Shell.
