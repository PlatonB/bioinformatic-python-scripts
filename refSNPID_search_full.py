...
def table_split(src_file_opened, rs_col_index, pval_column, pval_threshold, ram_size, stop_reading):
        ...
        while src_file_opened.tell() - init_mem_usage < ram_size // 8:
...
base_num_of_headers = int(input('''Количество не считываемых строк в начале "базы"
...
if base_pval_column == '':
        ...
        base_pval_threshold = float(input('''Верхний порог выбранной величины
[5.00e-19|(...)]
значения выбранной величины ≤ '''))
