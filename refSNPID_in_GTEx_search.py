...
def clean_and_sort(two_dim, rs_col_index):
        '''
        ...
        two_dim_pure.sort(key = lambda row: row[rs_col_index])
        return two_dim_pure

def dict_create(two_dim_pure, rs_col_index):
        '''
        ...
        for index in range(1, len(two_dim_pure)):
                if two_dim_pure[row_num][rs_col_index] != two_dim_pure[row_num - 1][rs_col_index]:
                        rs_and_ann_dict[two_dim_pure[row_num][rs_col_index]] = [two_dim_pure[row_num]]
                else:
                        rs_and_ann_dict[two_dim_pure[row_num - 1][rs_col_index]] += [two_dim_pure[row_num]]
                row_num += 1
        return rs_and_ann_dict

def rs_search(one_or_more_col_two_dim, rs_col_index, rs_and_ann_dict):
        '''
        ...
        for row in one_or_more_col_two_dim:
                rs = row[rs_col_index]
                if rs in rs_and_ann_dict:
                        out_two_dim += rs_and_ann_dict[rs]
                        del rs_and_ann_dict[rs]
        return out_two_dim
...
gtex_two_dim_pure = clean_and_sort(gtex_two_dim, gtex_rs_col_index)
