...
def cell_split(cell, sort_rule, cur_start_index = 0):
        ...
        '''
        #Регулярное выражение, находящее набор символов,
        #соответствующий представленному в любом виде числу.
...
col_numbers = input('''\nНомер одного или номера нескольких определяющих сортировку столбцов (через пробел)
(игнорирование ввода ==> сортировка по всем столбцам): ''').split()
reverse_val = input('''\nСортировать в обратном порядке?
(игнорирование ввода ==> no)
[yes(|y)|no(|n)|<enter>]: ''')
